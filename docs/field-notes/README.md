...
| [06 · 隱私脫敏 gateway 架構](06-privacy-masking-gateway.md) | 訂閱制雲端 agent 之前，客戶對話、Odoo 與 email 的個資怎麼脫敏與還原？（設計定案，待 spike 驗證） |

前四篇共同說明元件、通訊架構、實際工作情境與治理邊界；第 05 篇是公開討論**定案**（Grok／GPT-5.6-Luna／Kimi；已釘成本、實作、SSO）；第 06 篇是隱私脫敏的架構設計紀錄，標明待驗證項目，尚未上線。
